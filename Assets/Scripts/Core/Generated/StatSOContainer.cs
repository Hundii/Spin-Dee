...
public Stat health;
public Stat microbeSpawnRate;
public Stat moleculeDetectionRange;
public Stat moleculeSpawnRate;
public Stat moveSpeed;
public Stat pointWorth;
...
microbeSpawnRate = objects.Where(x=>x.name == "Microbe Spawn Rate").First();
moleculeDetectionRange = objects.Where(x=>x.name == "Molecule Detection Range").First();
moleculeSpawnRate = objects.Where(x=>x.name == "Molecule Spawn Rate").First();
moveSpeed = objects.Where(x=>x.name == "Move Speed").First();
pointWorth = objects.Where(x=>x.name == "PointWorth").First();
